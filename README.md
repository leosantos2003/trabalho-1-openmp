...
Para leitura, análise crítica e preparação dos slides, [experimentos/resultados.md](experimentos/resultados.md) reúne os dados locais. Na coleta final, execute `python3 experimentos_hype/gerar_resultados_hype.py`; o arquivo [experimentos_hype/resultados_hype.md](experimentos_hype/resultados_hype.md) acrescentará o inventário dos relatórios do VTune.
